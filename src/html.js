import React from 'react'; export default function HTML(props) { return (
<html {...props.htmlAttributes}>

<head>
    <meta charSet="utf-8" />
    <meta httpEquiv="x-ua-compatible" content="ie=edge" />
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" /> {props.headComponents} {/* Appzi: Capture Insightful Feedback */} {/*
    <script*/} {/* async*/} {/* src="https://w.appzi.io/bootstrap/bundle.js?token=iIhbb" */} {/*/>*/} {/* End Appzi */}
