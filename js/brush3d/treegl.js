...
(function() {
    ...
    p5.RendererGL.prototype.treeLocation = function(vector, {
        ...
        if ((from == 'SCREEN') && (to == 'WORLD')) {
            let t = this._location({ vector: vector, pMatrix: pMatrix, vMatrix: vMatrix, pvMatrix: pvMatrix, pvInvMatrix: pvInvMatrix })
            return createVector(t[0],t[1], t[2])
        }
    ...
    p5.RendererGL.prototype._screenLocation = function({
        ...
        return this.createVector(target[0], target[1], target[2]);
    }

    p5.RendererGL.prototype._location = function({
        vector = this.createVector(this.width / 2, this.height / 2, 0.5),
        pMatrix,
        vMatrix,
        pvMatrix,
    ...
    p5.RendererGL.prototype._worldToScreenDisplacement = function(vector, pMatrix = this.uPMatrix) {
        ...
        if (perspective) {
            let position = this.createVector();
