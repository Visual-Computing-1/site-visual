...
[link checker](https://github.com/Visual-Computing-1/visual-site/blob/master/docs/Front%20End%20Documentation.md).
...
- Some sources will automatically have tooltips generated for them (listed
  [here](https://github.com/Visual-Computing-1/visual-site/blob/947a3ac220e330fa03aa5b53a201f80b0f4c208f/src/models/problem.ts#L22)).
...
[`src/mdx-plugins/rehype-snippets.js`](https://github.com/Visual-Computing-1/visual-site/blob/master/src/mdx-plugins/rehype-snippets.js).
