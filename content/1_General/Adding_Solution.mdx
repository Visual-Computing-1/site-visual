...
2.  If it doesn't already exist, create a new `mdx` file in `solutions/`
    ...
    [`usaco-690.mdx`](https://github.com/Visual-Computing-1/visual-site/blob/master/solutions/usaco-690.mdx):
...
4.  In the module's `.problems.json` file (in this case,
    [`Binary_Search.problems.json`](https://github.com/Visual-Computing-1/visual-site/blob/master/content/3_Silver/Binary_Search.problems.json)),
    ...
    [`extraProblems.json`](https://github.com/Visual-Computing-1/visual-site/blob/master/content/extraProblems.json).
...
- For Bronze through Gold in particular, do not use additional macros
  ...
  [Github #806](https://github.com/Visual-Computing-1/visual-site/issues/806)):
