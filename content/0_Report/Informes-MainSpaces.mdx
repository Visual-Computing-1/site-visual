...
<center>
![Vectores base en 3 dimensiones](https://visual-computing-1.github.io/visual-site/js/brush3d/img/point.png)
</center>
...
<center>
![Tipos de Transformaciones ](https://visual-computing-1.github.io/visual-site/js/brush3d/img/transformation.png)
</center>
        ...
        <html>
          <head>
            ...
            <script src=https://cdnjs.cloudflare.com/ajax/libs/p5.js/1.4.1/addons/p5.sound.min.js></script>
             <script src=https://cdn.jsdelivr.net/gh/VisualComputing/p5.treegl/p5.treegl.js></script> 
             <script src=https://cdn.jsdelivr.net/gh/freshfork/p5.EasyCam@1.2.1/p5.easycam.js></script>        
            <script src='https://visual-computing-1.github.io/visual-site/js/brush3d/sketch2.js'></script>
          </head>
          <body>
          </body>
        </html>
